...
export const PhoneInput = forwardRef<HTMLInputElement, PhoneInputProps>(
  (
    ...
    const inputClasses = cn(
      "flex items-center gap-1 relative bg-transparent transition-colors text-base rounded-md border border-input pl-3 py-1 disabled:opacity-50 disabled:cursor-not-allowed md:text-sm has-[input:focus]:outline-none has-[input:focus]:ring-1 has-[input:focus]:ring-ring [interpolate-size:allow-keywords]",
    ...
    return (
      <div className={inputClasses}>
        ...
        <input
          ...
          name="phone"
          className={cn(
            "flex w-full border-none bg-transparent text-base transition-colors placeholder:text-muted-foreground outline-none  py-3  leading-none md:text-sm [interpolate-size:allow-keywords]",
            className
          )}
          {...props}
        />
